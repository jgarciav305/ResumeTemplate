...
\section{Projects} 
    ...
    \resumeProjectHeading
        ...
        \\[5mm]
    \resumeItemListStart
        \resumeItem{Developed a Django-based web application for discovering and filtering restaurants by cuisine, location, and user preferences}
        \resumeItem{Implemented backend logic with \textbf{Django} models and views backed by a relational \textbf{SQLite} database}
    \resumeItemListEnd

 \vspace{-20pt}
 \resumeProjectHeading
            {\textbf{{HTTP Server}} $|$ \emph{\href{https://empor.ca/}{Source Code}}}{NextJS $|$ TypeScript $|$ Spring Boot}
            \\[5mm]
          \resumeItemListStart
